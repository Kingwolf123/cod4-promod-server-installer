...
function Wait-ForPromodFiles {
    ...
    Write-Host ""
    Write-Host "Read BEGINNER_GUIDE.txt if you need the exact file list to put in fast download server directory.Generally in fast download , only .iwd and .ff are needed. We dont want any demo folders or .cfg files"
